  ...
  modal.innerHTML = '<div class="modal-content">' +
    ...
    '<div class="modal-body">' +
      ...
      '<div class="modal-tab-panel" id="emTab1">' +
        ...
        '<div class="fp"><label>平仓价</label><input type="number" id="emClosePrice" step="0.01" value="' + (item.closePrice ?? '') + '" /></div>' +
        ...
        '<div class="fp"><label>持仓最低价</label><input type="number" id="emLowPrice" step="0.01" value="' + (item.lowPrice != null ? item.lowPrice : '') + '" style="color:var(--color-danger);" /></div>' +
        '<div class="fp"><label>持仓最高价</label><input type="number" id="emHighPrice" step="0.01" value="' + (item.highPrice != null ? item.highPrice : '') + '" style="color:var(--color-success);" /></div>' +
